...
object ClassDecoratorContext {
  ...
  inline def apply[Class /* <: Instantiable1[/* args */ Any, Any] */](addInitializer: js.ThisFunction0[/* this */ Class, Unit] => Unit, metadata: DecoratorMetadata): ClassDecoratorContext[Class] = {
    val __obj = js.Dynamic.literal(addInitializer = js.Any.fromFunction1(addInitializer), kind = "class", metadata = metadata.asInstanceOf[js.Any])
