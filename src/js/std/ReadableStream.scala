...
trait ReadableStream[R] extends StObject {
  ...
  def getReader(options: ReadableStreamGetReaderOptions): org.scalajs.dom.ReadableStreamReader[R] = js.native
  /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/ReadableStream/getReader) */
  /* standard dom */
  def getReader(options: Mode): ReadableStreamBYOBReader = js.native
  /* standard dom */
  @JSName("getReader")
  def getReader_ReadableStreamReader(): org.scalajs.dom.ReadableStreamReader[R] = js.native
