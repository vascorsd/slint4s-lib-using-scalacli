...
trait RTCIceTransportEventMap extends StObject {
  ...
  /* standard dom */
  var selectedcandidatepairchange: org.scalajs.dom.Event
...
object RTCIceTransportEventMap {
  ...
  implicit open class MutableBuilder[Self <: RTCIceTransportEventMap] (val x: Self) extends AnyVal {
    ...
    inline def setSelectedcandidatepairchange(value: org.scalajs.dom.Event): Self = StObject.set(x, "selectedcandidatepairchange", value.asInstanceOf[js.Any])
