...
import typings.std.WebTransportErrorOptions
import typings.std.WebTransportErrorSource
...
@JSGlobal("WebTransportError")
@js.native
/* standard dom */
open class WebTransportError ()
  extends StObject
     with typings.std.WebTransportError {
  def this(message: java.lang.String) = this()
  def this(message: java.lang.String, options: WebTransportErrorOptions) = this()
  def this(message: Unit, options: WebTransportErrorOptions) = this()
  ...
  /* standard dom */
  /* CompleteClass */
  override val source: WebTransportErrorSource = js.native
  
  /** [MDN Reference](https://developer.mozilla.org/docs/Web/API/WebTransportError/streamErrorCode) */
  /* standard dom */
  /* CompleteClass */
  override val streamErrorCode: Double | Null = js.native
}
