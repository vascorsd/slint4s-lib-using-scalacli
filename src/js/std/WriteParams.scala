...
trait WriteParams extends StObject {
  ...
  /* standard dom */
  var data: js.UndefOr[BufferSource | org.scalajs.dom.Blob | java.lang.String | Null] = js.undefined
...
object WriteParams {
  ...
  implicit open class MutableBuilder[Self <: WriteParams] (val x: Self) extends AnyVal {
    ...
    inline def setData(value: BufferSource | org.scalajs.dom.Blob | java.lang.String): Self = StObject.set(x, "data", value.asInstanceOf[js.Any])
